...
<head>
    ...
    <body>        
        <div class="container">
            ...
            <div class="tm-right-column">
                <div class="tm-content-div">
                    <section id="contact" class="tm-section">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <form action="php/post.php" method="post" class="contact-form">
                                        <div class="form-group">
                                            <input type="text" id="contact_email" name="name" class="form-control" placeholder="Name"  required/>
                                        </div>     
                                        <div class="form-group">
                                            <input type="text" id="contact_name" name="email" class="form-control" placeholder="Login"  required/>
                                        </div>
                                        <div class="form-group">
                                            <input type="pass" name="fio" class="form-control" placeholder="Password"  required/>
                                        </div>                                     
            ...
            <?php else:?>
                <p>Привет <?=$_COOKIE['user']?>. Чтобы выйти нажмите ссылку <a href='/php/exit.php'>tutaj</a>
                </p> 
            <?php endif;?> 
